    ...
    >
      ...
      >
        <v-row>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span class="pt-1">30 La Maza, A Coruña, España</span>
              </v-card-text>
              ...
              >
                ...
                <span class="pt-1"> Call us at (34) 655-655655 </span>
              </v-card-text>
              <v-card-text
                class="pt-1 pb-3 px-0 d-flex"
                style="gap: 15px"
              >
                ...
                <span class="pt-1"> example@domain.com </span>
              </v-card-text>
            </v-card>
            <div
              class="social d-flex"
          ...
          <!--  <v-col cols="12">
            <div
              class="img-parent text-center mt-10"
        ...
        <v-row class="pt-7 bg-white">
          <v-col cols="6">
            <p style="color: black">
              &copy; {{ new Date().getFullYear() }} ROKA Dev. All Rights
              Reserved. Powered By Roka
            </p>
          </v-col>
          <v-col cols="6">
            <div
